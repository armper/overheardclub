...
describe('Service Tests', () => {
  describe('Rank Service', () => {
    ...
    let elemDefault: IRank;
    let expectedResult: IRank | IRank[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RankService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a Rank', () => {
        ...
        service.create(new Rank()).subscribe(resp => (expectedResult = resp.body));

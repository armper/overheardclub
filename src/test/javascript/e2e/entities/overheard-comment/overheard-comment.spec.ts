...
import { OverheardCommentComponentsPage, OverheardCommentDeleteDialog, OverheardCommentUpdatePage } from './overheard-comment.page-object';
...
describe('OverheardComment e2e test', () => {
  ...
  it('should create and save OverheardComments', async () => {
    ...
    expect(await overheardCommentUpdatePage.getDateInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await overheardCommentComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last OverheardComment', async () => {
    ...
    expect(await overheardCommentDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Overheard Comment?');

...
/**
 * REST controller for managing {@link com.perea.overheard.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
     ...
     */
    @GetMapping("/comments")
    public ResponseEntity<List<Comment>> getAllComments(CommentCriteria criteria) {
        log.debug("REST request to get Comments by criteria: {}", criteria);
        List<Comment> entityList = commentQueryService.findByCriteria(criteria);

package com.perea.overheard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.perea.overheard.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.perea.overheard.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.perea.overheard.domain.Post.class.getName() + ".userUpranks");
